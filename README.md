...
19년 5개월간 **Java**와 **전자정부프레임워크**를 활용한 백엔드/서버개발 전문가로 활동하고 있습니다.

전자정부프레임워크를 활용한 공공기관 웹 시스템 및 MES 시스템 개발에 특화되어 있으며, Java 기반의 안정적이고 확장 가능한 시스템 구축에 강점을 가지고 있습니다. 프로젝트 관리자(PM)로서 포스코케미칼, 포스코스틸리온, 경북테크노파크 등 대규모 프로젝트를 성공적으로 수행해왔습니다.
...
- **경상북도경제 진흥원 기업규제현장지원단 시스템** - Java / 전자정부프레임워크 / MariaDB (개발) - [사이트](https://gbrc.gepa.kr/)
...
**2015.12 ~ 현재 재직 중 (10년 1개월)**

전자정부프레임워크를 활용한 공공기관 웹 시스템 및 MES 시스템 개발에 특화되어 있으며, Java 기반의 안정적이고 확장 가능한 시스템 구축을 담당하고 있습니다. 프로젝트 관리자(PM)로서 포스코케미칼, 포스코스틸리온, 경북테크노파크 등 대규모 프로젝트를 성공적으로 수행하며, Java, JSP, 전자정부프레임워크, Oracle, MySQL, PostgreSQL, Node.js 등 다양한 기술 스택을 활용하여 고객의 요구사항에 맞는 최적의 솔루션을 제공합니다.
